...
response1 = yelp_api.search_query(term='food', location='toronto', limit=2)
response2 = yelp_api.search_query(term='attractions', location='toronto', limit=2)

import geocoder
g = geocoder.ip('me')

# Gives latitude and longitude of closest "term" from current location
response_cur = yelp_api.search_query(term='ice cream', latitude = g.latlng[0],
